...
class RawMaterialStockInServiceTest {
    ...
    @Test
    void testStockIn_RawMaterialNotFound() {
        ...
        ResourceNotFoundException exception = assertThrows(
                ...
                () -> rawMaterialService.stockIn(rawMaterialId, quantity)
        );
    ...
    void testStockIn_Success() {
        // Path 2: raw material ditemukan dan stok berhasil ditambahkan
        ...
        RawMaterial result = rawMaterialService.stockIn(rawMaterialId, quantity);
